...
const permute = /*#__PURE__*/ tslFn(([x_immutable]) => {
	const x = vec4(x_immutable).toVar()

	return mod(x.mul(34.0).add(1.0).mul(x), 289.0)
})

const taylorInvSqrt = /*#__PURE__*/ tslFn(([r_immutable]) => {
	const r = vec4(r_immutable).toVar()

	return sub(1.79284291400159, mul(0.85373472095314, r))
})

export const fade = /*#__PURE__*/ tslFn(([t_immutable]) => {
...
export const cnoise = /*#__PURE__*/ tslFn(([P_immutable]) => {
